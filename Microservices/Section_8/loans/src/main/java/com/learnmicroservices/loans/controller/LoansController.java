package com.learnmicroservices.loans.controller;

import com.learnmicroservices.loans.constant.LoansConstants;
import com.learnmicroservices.loans.dto.ErrorResponseDto;
import com.learnmicroservices.loans.dto.LoansContactInfoDto;
import com.learnmicroservices.loans.dto.LoansDto;
import com.learnmicroservices.loans.dto.ResponseDto;
...
@RestController
@RequestMapping(path = "/loansApi",produces = MediaType.APPLICATION_JSON_VALUE)
@Validated
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside Dummy Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoansDto> fetchLoanDetails( @RequestHeader("demobank-correlation-id") String strCorrelationId,
                                                     @RequestParam
                                                     @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                     String mobileNumber) {
        logger.debug("Correlation demobank-correlation-id found in Loans Controller : {}",strCorrelationId);
